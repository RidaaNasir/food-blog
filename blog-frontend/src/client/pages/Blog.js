      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-gray-300 max-w-2xl mx-auto">
            ...
            restaurant reviews and recipes
          </p>
        </motion.div>
        ...
        <div className="mb-10">
          ...
          >
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label className="block text-pastel-pink-200 mb-2 text-sm">
                  From Date
                </label>
            ...
            <div className="flex justify-end mt-4 gap-2">
              <button onClick={applyDateFilters} className="btn btn-primary">
                Apply Filters
              </button>
              ...
              >
                <div className="relative aspect-square overflow-hidden">
                  {blog.image ? (
                    <img
                      src={
                        blog.image.startsWith('http') ? blog.image : `https://blog-backend-iurp.onrender.com/${blog.image.replace(/^\/+/, '')}`
                      }
                      alt={blog.title}
                    ...
                    <div className="w-full h-full bg-dark-300 flex items-center justify-center">
                      <span className="text-pastel-pink-300 opacity-50">
                        No image
                      </span>
                    </div>
                  )}
